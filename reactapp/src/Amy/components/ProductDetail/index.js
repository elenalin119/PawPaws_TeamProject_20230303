import { Dialog, DialogTitle, DialogContent, Slide, Box, IconButton, useMediaQuery, Typography, Button } from "@mui/material";
...
export default function ProductDetail({open, onClose, product}){
  ...
  return(
    <Dialog
      ...
      >
      <DialogTitle
      sx={{background: shades.secondary[500]}}>
        <Box
          display="flex"
          alignItems="center"
      ...
      <ProductDetailInfoWrapper>
            ...
            <Box
              ...
              justifyContent="space-between"
            >
              <Typography sx={{ lineHeight: 2,color: shades.blue[500] }} variant="h6"  >
              ${product.price}
            </Typography>
            </Box>
            <Box
